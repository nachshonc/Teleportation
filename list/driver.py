                ...
                for trials in range(1, numTrials+1):
                    ...
                    for line in struc:
                        ...
                        if stat[0] in stats.keys():
                            ...
                            print 'warning:\n\t\t{}'.format(stat[1])
                    #if t>16 and pgm.startswith("listH") and trials>=2:
                     #   break
                print ""
                ...
                if len(v) > 0:
                    ...
                    for t in v.keys():
                        if len(v[t]) != numTrials:
                            ...
                            print "t={}, len(v[t])={}, numTrials={}".format(t, len(v[t]), numTrials)
			    print "ERROR:\t{} length {}, expected {}".format(t, len(v[t]), numTrials)
                            #sys.exit(0)
